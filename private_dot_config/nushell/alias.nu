...
alias cch = ^cargo check --all-features
alias ccha = ^cargo check --all-features --all-targets
alias ccy = ^cargo clippy --all-features
alias ccya = ^cargo clippy --all-features --all-targets
