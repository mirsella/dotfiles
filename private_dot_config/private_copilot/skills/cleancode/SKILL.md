---
name: cleancode
description: Aggressively refactor and simplify code for clarity, maintainability, and lower net diff size while preserving intended behavior.
---
...
4. **Prefer low-concept, idiomatic code**
...
6. **Make invalid states impossible or obvious**
